  ...
  render() {
    ...
    return (
      <div>
        ...
        <Hero title={text.pageTitle} subtitle={text.pageSubTitle} img="carrentaldelivery" />
...
export const bannerImageQuery = graphql`
  query BannerImageQueryCarrentaldelivery {
    banner: imageSharp(id: { regex: "img/promobanner.png/" }) {
