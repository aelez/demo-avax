  ...
  render() {
    ...
    return (
      <div>
        ...
        <Hero title={text.pageTitle} subtitle={text.pageSubTitle} img="rentmotocycle" />
...
export const bannerImageQuery = graphql`
  query BannerImageQueryRentmotocycle {
    banner: imageSharp(id: { regex: "img/banner_moto.jpg/" }) {
